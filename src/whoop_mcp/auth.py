...
def main() -> None:
    ...
    print("\nNext steps:")
    print("  1. Test:      whoop-mcp-server  (if installed via pip)")
    print("  2. Or test:   python -m whoop_mcp.server")
    print("  3. Register:  claude mcp add --transport stdio whoop --scope user -- "
          f"{sys.executable} -m whoop_mcp.server")
    print("  4. Verify:    start `claude`, then run /mcp\n")
